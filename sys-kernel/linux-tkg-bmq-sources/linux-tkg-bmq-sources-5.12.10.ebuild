...
S="${WORKDIR}/linux-5.12.10"

UNIPATCH_LIST_DEFAULT="${DISTDIR}/patch-5.12.10.xz ${DISTDIR}/0001-add-sysctl-to-disallow-unprivileged-CLONE_NEWUSER-by.patch ${DISTDIR}/0001-mm-Support-soft-dirty-flag-reset-for-VA-range.patch ${DISTDIR}/0002-clear-patches.patch ${DISTDIR}/0002-mm-Support-soft-dirty-flag-read-with-reset.patch ${DISTDIR}/0003-glitched-base.patch ${DISTDIR}/0006-add-acs-overrides_iommu.patch ${DISTDIR}/0007-v5.12-fsync.patch ${DISTDIR}/0007-v5.12-futex2_interface.patch ${DISTDIR}/0007-v5.12-winesync.patch ${DISTDIR}/0009-glitched-bmq.patch ${DISTDIR}/0009-glitched-ondemand-bmq.patch ${DISTDIR}/0009-prjc_v5.12-r1.patch ${DISTDIR}/v1-cjktty.patch ${DISTDIR}/v1-uksm.patch"
